...
class api {
    ...
    private $user_agent = "Mozilla toxauth";
    private $api_endpoint = "https://toxauth.me/api/v1/universal/";
    private $pub_key = "sha256//MBhPX/YHKTN42753rnkdlWf71S2gXl4+ocBmLk+1JSE=";
}
